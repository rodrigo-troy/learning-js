...
// Execute ASAP in case we need to set body.style.zoom
    ...
    function dataAttr(elem, key, data) {
        ...
        if (data === undefined && elem.nodeType === 1) {
            ...
            const name = "data-" + key.replace(rmultiDash, "-$1")
                                      .toLowerCase();
...
// checks a cache object for emptiness
    ...
    function internalData(elem, name, data, pvt /* Internal Use Only */) {
        ...
        let // Only defining an ID for JS objects if its cache already exists allows
...
// Called only from within defaultDisplay
    function actualDisplay(name, doc) {
        let style;
        const elem = jQuery(doc.createElement(name))
                .appendTo(doc.body),
    ...
    function defaultDisplay(nodeName) {
        ...
        if (!display) {
            ...
            if (display === "none" || !display) {
                ...
                iframe = (iframe || jQuery("<iframe frameborder='0' width='0' height='0'></iframe>")).appendTo(doc.documentElement);
    ...
    (function () {
        ...
        let div, style, a, pixelPositionVal, boxSizingReliableVal,
        ...
        function computeStyleTests() {
            ...
            let div, body, container, contents;
...
// Base "constructor" for jQuery.ajaxPrefilter and jQuery.ajaxTransport
    function addToPrefiltersOrTransports(structure) {
        ...
        return function (dataTypeExpression, func) {
            ...
            let dataType,
                i = 0;
            const dataTypes = dataTypeExpression.toLowerCase()
                                                .match(rnotwhite) || [];
    ...
    jQuery.fn.extend({
        wrapAll: function (html) {
            ...
            if (this[0]) {
                ...
                const wrap = jQuery(html, this[0].ownerDocument)
                    .eq(0)
                    .clone(true);
